<?php 
    ...
    if(!empty($_SESSION['username']) and !empty($_SESSION['password'])){
        ...
        <head>
            ...
            <title>Halaman Administrator Digital Offset</title>
            <link rel="icon" href="gambar/Dicon.png" type="image/ico" />
            ...
            <body>
                <div id="wrapper">
                    ...
                    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="?tampil=beranda">Administrator</a>
                        </div>
                        <!-- /.navbar-header -->
                        <?php include("admin170117/menu_atas.php") ?>
                        <?php include("admin170117/menu_kiri.php") ?>
                    </nav>
                    <div id="page-wrapper">
                ...
                <div id="footer" style="height: 65px; margin: 0 auto;  color: #1933EC; background-color:#f8f8f8; border:1px solid rgb(216, 215, 215);">
                    <p style="  padding: 12px 0 0; text-align: center;">
                        &copy;  Administrator Digital Offset&nbsp;<?php echo $dt['tahun']; ?> &nbsp;<br>
                        <small class="right">Digital Offset | Dibuat oleh : Mohammad Zuz Ubaidillah</small>
                    </p>
                </div>
                <!--END FOOTER -->
