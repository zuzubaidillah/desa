...
<head>
  ...
  <link rel="stylesheet" href="template/website/css/footer.css">
...
<body>
  ...
  <!-- Footer -->
  <footer class="footer" style=" background-color: <?= $dt['wmatas']; ?> !important;">
    <div class="container">
      <p class="m-0 text-center text-white">&copy; <?= $th; ?> Digital Offset</p>
    </div>
    <!-- /.container -->
  </footer>
...
global $nm_titel;
?>
<title><?= $nm_titel; ?>Digital Offset</title>
