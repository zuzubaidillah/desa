    ...
    <header>
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item carousel-item2 img-fluid2 active" style="background-image: url('gambar/slide/<?= $sql_s['gambar']; ?>')">
          ...
          <!-- Slide One - Set the background image for this slide in the line below -->
          <div class="carousel-item carousel-item2 img-fluid2" style="background-image: url('gambar/slide/<?= $sql_d['gambar']; ?>')">
            <div class="carousel-caption d-none d-md-block">
          ...
          <!-- Slide One - Set the background image for this slide in the line below -->
          <div class="carousel-item carousel-item2 img-fluid2" style="background-image: url('gambar/slide/<?= $sql_t['gambar']; ?>')">
            <div class="carousel-caption d-none d-md-block">
