        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12">  
                    ...
                    <?php if($_SESSION['bagian']=="admin" or $_GET['level']==2) { ?>

                    <!-- /. level==1 adalah USER jika selain 1 maka staf -->

                    <form name="tambah" method="post" action="?tampil=staf_tambah">
                                ...
                                <table class="table table-hover">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if($_SESSION['bagian']=="admin" and $_GET['level']==1){ ?>



                                            <td width="6%">

                                                <form style="display: inline-block;" name="lihat" method="post" action="?tampil=staf_edit">
                                                ...
                                                <form style="display: inline-block;" name="hapus" method="post" action="?tampil=staf_hapus">
