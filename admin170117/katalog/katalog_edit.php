<?php
    ...
    if (!empty($_POST['p'])) {
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit katalog <?php echo $judulpos; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="col-lg-12">                       
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <input autocomplete="off" required maxlength="70" name="judul" value="<?php echo $data['judulposting']; ?>" class="form-control" placeholder="Judul katalog">
                                    </div>
                                </div><br>
                                <div class="form-group">
                                    <label>Gambar</label><small>&nbsp;&nbsp;&nbsp;&nbsp;*jpg jpeg png</small>
                                    <input type="file" name="gambar">
                                    <img src="gambar/katalog/<?php echo $data['gambar']; ?>" width="250"/>
                                </div>  
                                <div class="col-lg-12">
