<?php
    ...
    if (!empty($_POST['p']) and $_POST['ket']==$sql['id_menu']) {
        ...
        $sql_sbb        = $mysqli->query ("SELECT * FROM submenu where id_submenu = '$_POST[p]' AND link='katalog'") or die (mysqli_error());
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">katalog <?php echo $judulpos; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <!-- row (nested) -->
                    <div class="row">
                        <form name="submit" method="post" action="?tampil=katalog_tambahproses" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <input autocomplete="off" required maxlength="70" name="judulposting" class="form-control" placeholder="Judul katalog" autofocus>
                                    </div>
                                </div><br>
