...
if(!defined("INDEX")) die("<center><h1>---<h1></center>");
    if (!empty($_GET['p']) and !empty($_GET['c']) and !empty($_GET['c']=='katalog') and $_GET['ket']==2) {
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="page-header">Katalog <?php echo $judulpos; ?>
                        <a target="_blank" name="lihat" title="lihat Data" href="index.php?tampil=katalog&w=<?= $judul['id_submenu']; ?>" class="btn btn-danger btn-circle"><i class="fa fa-eye "></i></a></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8">
                    <form name="tambah" method="post" action="?tampil=katalog_tambah">
                ...
                <div class="col-md-4">
                    <form action="?tampil=katalog&c=<?= $_GET['c']; ?>&ket=<?= $_GET['ket']; ?>&p=<?= $_GET['p']; ?>&hal=1" method="post">
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (isset($_POST["cari"])) {
                                        		...
                                        		$tampil = $mysqli->query ("SELECT * FROM posting where judulposting LIKE '%$_POST[keyword]%' and jenisposting = '$_GET[p]' and kategori='katalog' order by idposting DESC limit $posisi, $batas") or die (mysqli_error());
                                        	}else{
                                        		$tampil = $mysqli->query ("SELECT * FROM posting where jenisposting = '$_GET[p]' and kategori='katalog' order by tanggal desc limit $posisi, $batas") or die (mysqli_error());
                                        	}
                                        ...
                                        <tr>
                                            ...
                                            <td width="5%">
                                                    <a target="_blank" name="lihat" title="lihat Data" href="index.php?tampil=katalog-detail&k=<?= $data['idposting']; ?>" class="btn btn-danger btn-circle">
                                                        <i class="fa fa-eye "></i>
                                                    </a>
                                        	...
                                        	?>
                                            <td width="10%"><img src="gambar/katalog/<?php echo $data['gambar']; ?>" width="100"  /></td>
                            ...
                            <?php  
                            if (isset($_POST["cari"])) {
                                $semua      = $mysqli->query("SELECT * FROM posting where judulposting LIKE '%$_POST[keyword]%' and jenisposting = '$_GET[p]' and kategori='katalog'");
                                            ...
                                            <div class='col-sm-6'>
                                                <div class='dataTables_info'>
                                                    <div class='text-center'>
                                                        ...
                                                        if($hal > 1){
                                                            echo "
                                                            <form style='display: inline-block;' action='?tampil=katalog&c=$_GET[c]&ket=$_GET[ket]&p=$_GET[p]&hal=1' method='post'>
                                                            ...
                                                            <form style='display: inline-block;' action='?tampil=katalog&c=$_GET[c]&ket=$_GET[ket]&p=$_GET[p]&hal=$sebelumnya' method='post'>
                                                                <input type='hidden' name='keyword' value='$_POST[keyword]'>
                                ...
                                $semua      = $mysqli->query("SELECT * FROM posting where jenisposting = '$_GET[p]' and kategori='katalog'");
                                $jmldata    = mysqli_num_rows($semua);
                                $jmlhal     = ceil($jmldata/$batas);
                                $sebelumnya = $hal-1;
                                $berikutnya = $hal+1;
