                        ...
                        <form role="form">
                            <fieldset>
                                <div class="form-group">
                                    <input autocomplete="off" required class="form-control" placeholder="Username" name="username" type="text" autofocus value="z">
                                </div>
                                <div class="form-group">
                                    <input autocomplete="off" required class="form-control" placeholder="Password" name="password" type="password" value="z">
                                </div>
