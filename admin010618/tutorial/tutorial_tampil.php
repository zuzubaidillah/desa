...
if(!defined("INDEX")) die("<center><h1>---<h1></center>");
    if (!empty($_GET['p']) and !empty($_GET['c']) and !empty($_GET['c']=='tutorial') and $_GET['ket']==1) {
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="page-header">Tutorial <?php echo $judulpos; ?>
                        <a target="_blank" name="lihat" title="lihat Data" href="index.php?tampil=tutorial&w=<?= $judul['id_submenu']; ?>" class="btn btn-danger btn-circle"><i class="fa fa-eye "></i></a></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8">
                    <form name="tambah" method="post" action="?tampil=tutorial_tambah">
                ...
                <div class="col-md-4">
                    <form action="?tampil=tutorial&c=<?= $_GET['c']; ?>&ket=<?= $_GET['ket']; ?>&p=<?= $_GET['p']; ?>&hal=1" method="post">
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                                ...
                                <table class="table table-hover">
                                    <tbody>
                                        <?php
                                            ...
                                            if (isset($_POST["cari"])) {
                                                // $tutorial = cari($_POST["keyword"]);
                                        		$tampil = $mysqli->query ("SELECT * FROM posting where judulposting LIKE '%$_POST[keyword]%' and jenisposting = '$_GET[p]' and kategori='tutorial' order by idposting DESC limit $posisi, $batas") or die (mysqli_error());
                                        	}else{
                                        		$tampil = $mysqli->query ("SELECT * FROM posting where jenisposting = '$_GET[p]' and kategori='tutorial' order by tanggal desc limit $posisi, $batas") or die (mysqli_error());
                                        	}
                                        ...
                                        <tr>
                                            ...
                                            <td width="5%">
                                                    <a target="_blank" name="lihat" title="lihat Data" href="index.php?tampil=tutorial-detail&k=<?= $data['idposting']; ?>" class="btn btn-danger btn-circle">
                                                        <i class="fa fa-eye "></i>
                                                    </a>
                                        	...
                                        	?>
                                            <td width="10%"><img src="gambar/tutorial/<?php echo $data['gambar']; ?>" width="100"  /></td>
                            ...
                            <?php  
                            if (isset($_POST["cari"])) {
                                $semua      = $mysqli->query("SELECT * FROM posting where judulposting LIKE '%$_POST[keyword]%' and jenisposting = '$_GET[p]' and kategori='tutorial'");
                                            ...
                                            <div class='col-sm-6'>
                                                <div class='dataTables_info'>
                                                    <div class='text-center'>
                                                        ...
                                                        if($hal > 1){
                                                            echo "
                                                            <form style='display: inline-block;' action='?tampil=tutorial&c=$_GET[c]&ket=$_GET[ket]&p=$_GET[p]&hal=1' method='post'>
                                                            ...
                                                            <form style='display: inline-block;' action='?tampil=tutorial&c=$_GET[c]&ket=$_GET[ket]&p=$_GET[p]&hal=$sebelumnya' method='post'>
                                                                <input type='hidden' name='keyword' value='$_POST[keyword]'>
                                ...
                                $semua      = $mysqli->query("SELECT * FROM posting where jenisposting = '$_GET[p]' and kategori='tutorial'");
                                $jmldata    = mysqli_num_rows($semua);
                                $jmlhal     = ceil($jmldata/$batas);
                                $sebelumnya = $hal-1;
                                $berikutnya = $hal+1;
