<?php
    ...
    if (!empty($_POST['id'])) {
        $data=  mysqli_fetch_array($mysqli->query("SELECT * FROM posting WHERE idposting ='$_POST[id]' and kategori='tutorial'"));
        unlink ("gambar/tutorial/$data[gambar]");
        $mysqli->query("DELETE FROM posting WHERE idposting = '$_POST[id]' and kategori='tutorial'") or die (mysqli_error());
            echo "
