        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <!-- row (nested) -->
                    <div class="row">
                        <form enctype="multipart/form-data" name="edit" role="form" action="?tampil=staf_editproses" method="post">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>Bagian</label>
                                    <input autocomplete="off" maxlength="40" name="job" value="<?php echo $data['job']; ?>" class="form-control" placeholder="Bagian Pekerjaan">
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>Bagian</label>
                                    <input autocomplete="off" maxlength="40" required name="job" value="<?php echo $data['job']; ?>" class="form-control" placeholder="Bagian Pekerjaan">
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <img width="150" src="gambar/user/200x200.png">
                                </div>
                            </div>
