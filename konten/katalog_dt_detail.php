<?php
    ...
    $sql_ps     = $mysqli->query("SELECT * FROM posting WHERE idposting=$id_posting and kategori='katalog'");
    ...
    <div class="container">
      ...
      <ol class="breadcrumb shadow">
        ...
        <li class="breadcrumb-item active">
          <a href="?tampil=katalog">Katalog</a>
        </li>
        <li class="breadcrumb-item active">
          <a href="?tampil=katalog&w=<?= $dt_submenu['id_submenu']; ?>"><?= $kat_sm; ?></a>
        </li>
      ...
      <div class="row" >
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 card shadow text-justifi">
          ...
          <!-- Preview Image -->
          <img class="img-fluid rounded" style="margin-top:  15px;" src="gambar/katalog/<?= $dt_ps['gambar']; ?>" alt="">
