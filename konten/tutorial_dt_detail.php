<?php
    ...
    $sql_ps     = $mysqli->query("SELECT * FROM posting WHERE idposting=$id_posting and kategori='tutorial'");
    ...
    <div class="container">
      ...
      <ol class="breadcrumb shadow">
        ...
        <li class="breadcrumb-item active">
          <a href="?tampil=tutorial">tutorial</a>
        </li>
        <li class="breadcrumb-item active">
          <a href="?tampil=tutorial&w=<?= $dt_submenu['id_submenu']; ?>"><?= $kat_sm; ?></a>
        </li>
      ...
      <div class="row" >
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 card shadow text-justifi">
          ...
          <!-- Preview Image -->
          <img class="img-fluid rounded" style="margin-top:  15px;" src="gambar/tutorial/<?= $dt_ps['gambar']; ?>" alt="">
